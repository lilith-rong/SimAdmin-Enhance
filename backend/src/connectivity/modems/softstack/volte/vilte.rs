...
//! new `m=video` line (H.264). The SIP envelope (`connectivity::modems::softstack::volte::sip::build_invite`)
...
/// [`VideoMediaDescription`].
///
/// Like [`crate::connectivity::modems::softstack::vowifi::voice::parse_audio_sdp`], this is permissive:
...
pub use crate::connectivity::modems::softstack::volte::rtp_relay::{
...
mod tests {
    ...
    use crate::connectivity::modems::softstack::vowifi::voice::{build_mo_audio_offer, SdpAddrType};
    ...
    fn av_sdp_carries_both_audio_and_video_media() {
        ...
        assert!(crate::connectivity::modems::softstack::vowifi::voice::parse_audio_sdp(sdp.as_bytes()).is_ok());
    }
