...
use crate::connectivity::modems::softstack::vowifi::qmi_uim::{UsimAkaApduResult, USIM_AID_PREFIX};
...
pub fn run_usim_aka(
    ...
    crate::connectivity::modems::softstack::vowifi::qmi_uim::execute_usim_authenticate_via_proxy_reason_with_retry(
        proxy_socket,
        device_path,
        slot,
        aid,
