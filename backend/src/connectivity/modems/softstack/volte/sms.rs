...
use crate::connectivity::core::sms_codec::{parse_mt_rp_data, MtSmsDeliver, SmsEncodingError};
...
pub fn build_rp_ack_body(reference: u8) -> Vec<u8> {
    crate::connectivity::core::sms_codec::build_network_rp_ack(reference)
}

// ============================ MO (send) side ============================

pub use crate::connectivity::core::sms_codec::MoSmsSubmission;
...
pub fn build_mo_submission(
    ...
    crate::connectivity::core::sms_codec::build_single_part_mo_submission(recipient, text, service_center)
}
...
pub fn build_mo_submissions(
    ...
    crate::connectivity::core::sms_codec::build_mo_submissions(recipient, text, service_center)
}
