...
use crate::platform::db::{Database, NewVowifiSoakRun, NewVowifiSoakSample};
...
mod tests {
    use super::*;
    use crate::{
        connectivity::modems::softstack::vowifi::executor::{
    ...
    async fn runner_result_persists_to_soak_tables() {
        ...
        let runner = LiveStageRunner::new(
            crate::connectivity::modems::softstack::vowifi::executor::LiveExecutorGateReport {
